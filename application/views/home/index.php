<!-- Hero Section Begin -->
<section class="hero set-bg" data-setbg="<?= base_url() ?>/assets/img/profil/bg19.png" style="background-color: black;">
    <div class="container">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="row">
                    <!-- forearch otomatisasi / cms -->
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="feature__item">
                            <img src="<?= base_url() ?>/assets/img/feature/feature-1.png" alt="">
                            <h5>Custom Software Development</h5>
                            <br>
                            <div align="center">
                                <a href="#"> <i class="btn btn-warning"> Detail</i></a>
                            </div>
                        </div>
                        <div class="feature__item">
                            <img src="<?= base_url() ?>/assets/img/feature/feature-2.png" alt="">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="feature__item right-column">
                            <img src="<?= base_url() ?>/assets/img/feature/feature-3.png" alt="">
